#include "rob599_nav_gazebo/volumetric_layer.hpp"
...
void VolumetricLayer::onInitialize()
{
...
void VolumetricLayer::matchSize()
{
...
void VolumetricLayer::resetMaps()
{
  // Call the base class method before adding our own functionality
...
void VolumetricLayer::updateBounds(
  ...
  double * min_y, double * max_x, double * max_y)
{
    ...
    ++it)
  {
    ...
    for (; iter_x != iter_x.end(); ++iter_x, ++iter_y, ++iter_z) {
      ...
      if (mz <= static_cast<unsigned int>(robot_voxel_height_)) {
...
void VolumetricLayer::raytraceFreespace(
...
void VolumetricLayer::updateOrigin(double new_origin_x, double new_origin_y)
{
